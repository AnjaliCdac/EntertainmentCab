...
public class ImagesUploadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.images_upload);
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
        mButtonChooseImage = findViewById(R.id.button_choose_imag);
        ...
        mButtonUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mUploadTask !=null && mUploadTask.isInProgress()) {
                    Toast.makeText(ImagesUploadActivity.this, "Upload in progress",
    ...
    private void uploadImage()
    {
        if(mImageUri!= null)
        {
            final StorageReference fileStorage=mStorageRef.child(System.currentTimeMillis()+
                    "."+getFileExtention(mImageUri));
            mUploadTask=fileStorage.putFile(mImageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                @Override
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    Toast.makeText(ImagesUploadActivity.this,"upload succesful",Toast.LENGTH_LONG).
                            show();
